...
updateResize();console.log("LOADING API");var tag=document.createElement('script');tag.src="https://www.youtube.com/iframe_api";var firstScriptTag=document.getElementsByTagName('script')[0];firstScriptTag.parentNode.insertBefore(tag,firstScriptTag);this.eventHandler('api-loading');soundStep=Math.ceil(100/((TRANSITION_TIME*1000)/CROSSFADE_TIMER_STEP))}
